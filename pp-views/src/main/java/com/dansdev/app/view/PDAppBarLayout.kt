    ...
    private fun initSizes(attrs: AttributeSet?) {
        ...
        attrs?.also {
            ...
            percentWidth = sizeManager.width(
                ta.getFloat(R.styleable.PDAppBarLayout_pd_width, 0f),
                ta.getFloat(R.styleable.PDAppBarLayout_pd_widthLong, 0f)
            )

            percentHeight = sizeManager.height(
                ta.getFloat(R.styleable.PDAppBarLayout_pd_height, 0f),
                ta.getFloat(R.styleable.PDAppBarLayout_pd_heightLong, 0f)
            )

            percentMarginTop = sizeManager.height(
                ta.getFloat(R.styleable.PDAppBarLayout_pd_marginTop, 0f),
                ta.getFloat(R.styleable.PDAppBarLayout_pd_marginTopLong, 0f)
            )

            percentMarginBottom = sizeManager.height(
                ta.getFloat(R.styleable.PDAppBarLayout_pd_marginBottom, 0f),
                ta.getFloat(R.styleable.PDAppBarLayout_pd_marginBottomLong, 0f)
            )

            percentMarginStart =
                sizeManager.width(ta.getFloat(R.styleable.PDAppBarLayout_pd_marginStart, 0f))
            percentMarginEnd =
                sizeManager.width(ta.getFloat(R.styleable.PDAppBarLayout_pd_marginEnd, 0f))
