...
open class PDConstraintLayout : ConstraintLayout {
    ...
    private fun initSizes(attrs: AttributeSet?) {
        ...
        attrs?.also {
            ...
            percentPaddingStart =
                sizeManager.width(ta.getFloat(R.styleable.PDConstraintLayout_pd_paddingStart, 0f))
            percentPaddingEnd =
                sizeManager.width(ta.getFloat(R.styleable.PDConstraintLayout_pd_paddingEnd, 0f))
            percentPaddingTop = sizeManager.height(
                ta.getFloat(R.styleable.PDConstraintLayout_pd_paddingTop, 0f),
                ta.getFloat(R.styleable.PDConstraintLayout_pd_paddingTopLong, 0f)
            )
            percentPaddingBottom = sizeManager.height(
                ta.getFloat(R.styleable.PDConstraintLayout_pd_paddingBottom, 0f),
                ta.getFloat(R.styleable.PDConstraintLayout_pd_paddingBottomLong, 0f)
            )
